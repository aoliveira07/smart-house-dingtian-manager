 ...
 *{box-sizing:border-box}main{max-width:1180px;margin:auto;padding:28px 28px 90px}h1{font-size:30px;line-height:1.2;margin:0 0 8px;letter-spacing:-.8px}h2{font-size:21px;margin:0 0 8px}p{margin:4px 0 16px}.muted{color:var(--secondary-text-color,#60747d)}.eyebrow{font-size:11px;letter-spacing:2px;font-weight:750;text-transform:uppercase;color:var(--primary-color,#087f8c);margin:0 0 12px}
 ...
 :host{height:100%;min-height:0;overflow-x:hidden;overflow-y:auto;-webkit-overflow-scrolling:touch;touch-action:pan-y}main{width:100%;min-width:0;padding:16px 12px 32px;padding-bottom:max(32px,env(safe-area-inset-bottom))}header{min-width:0}header>div{min-width:0}header:has(.overview-action){grid-template-columns:1fr}header>.overview-action{width:100%;margin:0;justify-self:stretch;min-height:48px}.overview-action{width:100%;min-height:48px}.export-bar{padding:0;margin-top:16px}.module-row{grid-template-columns:minmax(0,1fr) 44px 44px;gap:10px 8px;padding:12px}.module-row .module-title,.module-row .actions{display:contents}.module-row h3{grid-column:1;grid-row:1;margin:0}.module-row .usage{grid-column:2/4;grid-row:1;text-align:right;white-space:nowrap}.module-row .usage small{display:none}.module-row .badge{grid-column:1;grid-row:2;justify-self:start;align-self:center}.module-row .serial{display:none}.module-row .actions .primary{grid-column:1/-1;grid-row:3;width:100%;min-height:48px;font-size:15px}.module-row .actions .icon-button{grid-column:2;grid-row:2}.module-row .actions .danger{grid-column:3;grid-row:2}.filter-bar{display:flex;flex-direction:column;align-items:stretch;overflow:visible;gap:10px;padding:0;margin:8px 0 12px}.filter-bar label{order:0;display:flex;width:100%;min-width:0;margin:0;gap:10px;white-space:nowrap}.filter-bar select{flex:1;width:0;min-width:0;max-width:none}.filter-bar .selection-actions{order:1;width:100%;display:grid;grid-template-columns:1fr 1fr;gap:8px}.filter-bar .actions button{width:100%;min-width:0;min-height:48px;padding:8px;font-size:13px}.channel{grid-template-columns:minmax(64px,1fr) minmax(95px,1.2fr) auto;gap:10px;padding:12px}.channel .position{grid-column:1;grid-row:1}.channel .channel-type{grid-column:2;grid-row:1;min-width:0}.channel .channel-use{grid-column:3;grid-row:1;min-width:0;gap:6px;justify-content:flex-end}.channel .channel-name{grid-column:1/-1;grid-row:2}.channel .channel-area{grid-column:1/-1;grid-row:3}.channel .test-control{grid-column:1/-1;grid-row:4;width:100%;justify-self:stretch}.command-toggle{width:100%;min-height:48px;font-size:16px}.channels{overflow:hidden}.channel input,.channel select{min-width:0}
 }
`; 
