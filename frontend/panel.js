...
export class DingtianPanel extends HTMLElement {
  ...
  renderModule(main) {
    ...
    for(const c of m.channels){
      ...
      channels.append(el('article',{className:'channel'},el('div',{className:'position'},`R${c.number}`),test,el('label',{className:'channel-name'},'Nome do canal',display),el('label',{},'Tipo',type),el('label',{className:'inline'},use,'Usar canal'),details));
    }
